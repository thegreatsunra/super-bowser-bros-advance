...
bn::vector<int, 32> Level::t_floor_tiles() { return m_floor_tiles; }

bn::vector<int, 32> Level::t_wall_tiles() { return m_wall_tiles; }

bn::vector<int, 32> Level::t_ceil_tiles() { return m_ceil_tiles; }
